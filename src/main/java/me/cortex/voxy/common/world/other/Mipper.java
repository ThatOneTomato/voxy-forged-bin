...
public class Mipper {
    ...
    public static long mip(long I000, long I100, long I001, long I101,
        ...
        if (max != -1) {
            ...
            //blockLight summed the high nibbles, so /8 already leaves the average in the high nibble;
            // shifting it left by 4 again pushed it past 8 bits and corrupted the packed light value.
