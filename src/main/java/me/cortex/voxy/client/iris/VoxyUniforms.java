...
public class VoxyUniforms {
    ...
    public static Matrix4f getViewProjection() {//Current-frame: the viewport is set up at renderLevel HEAD, before Iris reads these per-frame uniforms
    ...
    public static Matrix4f getModelView() {//Current-frame: the viewport is set up at renderLevel HEAD, before Iris reads these per-frame uniforms
        var getVrs = (IGetVoxyRenderSystem) Minecraft.getInstance().levelRenderer;
        if (getVrs == null || getVrs.getVoxyRenderSystem() == null) {
            return new Matrix4f();
        }
    ...
    public static Matrix4f getProjection() {//Current-frame: the viewport is set up at renderLevel HEAD, before Iris reads these per-frame uniforms
        var getVrs = (IGetVoxyRenderSystem) Minecraft.getInstance().levelRenderer;
        if (getVrs == null || getVrs.getVoxyRenderSystem() == null) {
            return new Matrix4f();
        }
